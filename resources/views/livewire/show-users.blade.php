<div>
  <div class="grid grid-cols-6 mb-4">
    <div class="col-span-6 sm:col-span-1 pr-2">
      ...
      <select wire:model.change="perPage" id="location"
    ...
    @if ($super)
      <div class="col-span-6 sm:col-span-2 pr-2">
        ...
        <select wire:model.change="selectedTenant" id="tenant"
                class="mt-1 form-select block w-full pl-3 pr-10 py-2 text-base leading-6 border-gray-300 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
    ...
    <div class="col-span-6 {{$super == true ? 'sm:col-span-3' : 'sm:col-span-5'}}">
      <x-form_elements.text-input wire:model.live.debounce.250ms="search" label="Search" placeholder="Search Users..."/>
    </div>
  </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <div class="flex items-baseline gap-2">
                      ...
                      @if ($super)
                        <a wire:click="impersonate({{ $user->id }})" href="#" class="text-xs text-indigo-600">Impersonate</a>
                      @endif
                    </div>
